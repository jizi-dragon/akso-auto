...
```bash
node scripts/login.js --baseUrl https://standard-val.aksoegmp.com --username liyulong --password 88888888
```
...
```bash
# 开发环境
node scripts/login.js --baseUrl https://dev.aksoegmp.com --username dev_user --password dev123

# 测试环境
node scripts/login.js --baseUrl https://test.aksoegmp.com --username tester --password test456
